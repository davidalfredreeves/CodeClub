...
##
#### Problem 9 - hanoi
##print(functions.hanoi(1)) #Expect 1
##print(functions.hanoi(2)) #Expect 3
##print(functions.hanoi(3)) #Expect 7
##print(functions.hanoi(4)) #Expect 15
##print(functions.hanoi(5)) #Expect 31
##print(functions.hanoi(6)) #Expect 63
##print(functions.hanoi(7)) #Expect 127
##print(functions.hanoi(21)) 
##print(functions.hanoi(35))
##print(functions.hanoi(64))
##
#### Problem 10 - encode
...
##print(functions.hailNum(4)) #Expect [4, 2, 1]
##print(functions.hailNum(9)) #Expect [9, 28, 14, 7, 22, 11, 34, 17, 52, 26, 13, 30, 15, 46, 23, 50, 25, 76
##print(functions.hailNum(210))
##print(functions.hailNum(351*521))
##print(functions.hailNum(123**13))
##
